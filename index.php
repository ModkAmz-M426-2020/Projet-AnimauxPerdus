    ...
    <header>
      <div class="groupHeader">
        ...
        <div class="textHeader">
          <h1>Pet Search</h1>
          <p class="slogan">Retrouvez vos animaux grâce à nos annonces !</p>
        </div>
      </div>
      ...
      <div class="groupHeader">
        <!--
                ...
                ?>
             -->
        <a id="nouvelleAnnonce" class="iconeLien" href="html\creerAnnonce.php"> <img src="img/nouveau.png" \> </a>
        <a id="login" class="iconeLien" href="html\login\login.php"> <img src="img/login.png" \> </a>
        <div id="group1Header">
    </header>
    <nav>
